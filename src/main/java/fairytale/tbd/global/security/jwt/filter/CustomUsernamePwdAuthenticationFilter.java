...
public class CustomUsernamePwdAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
	...
	private static final Logger LOGGER = LogManager.getLogger(CustomUsernamePwdAuthenticationFilter.class);
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws
		...
		LOGGER.info("JWT Local Login ::: loginId = {}, password = {}", loginId, password);
